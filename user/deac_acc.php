...
<div class="nav-outer"> 
		...
		<ul class="select"><li><a href="buyticket.php"><b>Booking</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<!--	<div class="select_sub">
		<ul class="sub">
		...
		<ul class="current"><li><a href="deac_acc.php"><b>Deactive account</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<!--<div class="select_sub">
			<ul class="sub">
...
<div id="page-heading"><h1>Deactive account</h1></div>
