...
<div id="login-holder">
	...
	<div id="login-inner">
		...
		<tr>
			<th>Email</th>
			<td><input name="email" type="text" class="login-inp" id="email" /></td>
		</tr>
		<tr>
			<th>Password</th>
		...
		<!--<tr>
			<th></th>
			<td valign="top"><input type="checkbox" name="checkbox" value="checkbox" class="checkbox-size" id="checkbox" />
