...
<div> 
<span class="checkbox"> 
    <input type="checkbox" value="1" name="fieldMark[correct00]"  class="css-checkbox" 
...
<span class="checkbox"> 
    <input type="checkbox" value="1" name="fieldMark[correct00]"  class="css-checkbox" 
	<?php 
	$OK=isset($_POST['fieldMark']) ? true:false;
	if($OK && isset($missing) && in_array('1',$_POST['fieldMark'])) ?>
	checked="checked";
	<?php ?>
	> 
