...
<div class="nav-outer"> 
		...
		<div class="nav">
		<div class="table">
		<ul class="current"><li><a href="dashboard.php"><b>Dashboard</b><!--[if IE 7]><!--></a><!--<![endif]-->
...
<div id="page-heading"><h1>Bus Add</h1></div>
<!--  start product-table ..................................................................................... -->
 <form action="addbusindex.php" method="post">
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="companyname" /></td>
			<td></td>
		</tr>
		<!--<tr>
		...
		<td class="noheight">
			...
			<table border="0" cellpadding="0" cellspacing="0">
			<tr  valign="top">
		<select  id="y"  class="styledselect-Gender" name="departingtime" >
		...
		<td><input type="text" class="inp-form" name="coachno" /></td>
		<!--<td>	
		<select  class="styledselect_form_1">
			<option value="">All</option>
			<option value="">Products</option>
		...
		<th valign="top">Starting Counter</th>
				<td><input type="text" class="inp-form" name="startingcounter" /></td>
         </td>
		<td></td>
		</tr> 
		<!--<td class="noheight">
		...
		<td></td>
			...
			<td><input type="text" class="inp-form" name="endcounter" /></td>
			<td></td>
		</tr>
	
		<tr>
		<th valign="top">Fare</th>
		<td><input type="text" class="inp-form" name="fare" /></td>
			<td></td>
		</tr>
		...
		<td><input type="text" class="inp-form" name="coachtype" /></td>
			<td></td>
		</tr>
			...
			<table border="0" cellpadding="0" cellspacing="0">
			<tr  valign="top">
		<select  id="y"  class="styledselect-Gender" name="startingtime" >
						<!--<option value="Male">Male</option>
						<option value="Female">Female</option>-->
						<option>---</option>
            <option >1:00 AM</option>
			...
			<table border="0" cellpadding="0" cellspacing="0">
			<tr  valign="top">
		<select  id="y"  class="styledselect-Gender" name="arrivaltime" >
						<!--<option value="Male">Male</option>
						<option value="Female">Female</option>-->
						<option>---</option>
            <option >1:00 AM</option>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="totalseat" /><p>&nbsp; </p></td>
			<td></td>
		</tr>
		<tr>
		<th valign="top">Day</th>
		<td><input type="text" class="inp-form" name="day" /></td>
			<td></td>
		</tr>
		<!--<tr>
		<th valign="top">Seat Number</th>
		<td><input type="text" class="inp-form" name="seatno" /></td>
			<td></td>
		</tr>-->
		<tr>
		<th>&nbsp;</th>
